...
export default function Header({ page, onMenu, onNew }) {
  return <header className="topbar">
    ...
    <div className="header-actions"><span className="demo-label"><span />Données de démonstration</span>{!['requests', 'resident'].includes(page) && <button className="button button-dark button-small" onClick={onNew}><Icon name="plus" size={16} /><span>Nouvelle demande</span></button>}</div>
  </header>;
}
