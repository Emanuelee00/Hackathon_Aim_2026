...
export const spaces = [
  ...
  { id: 'chapelle', site: 'marseille', name: 'La Chapelle', capacity: 90, rate: 20, prices: { '2h': 40, half: 100, day: 200, weekly: 30 }, area: 114, color: 'peach', description: 'Chapelle désacralisée pour concerts, spectacles, danse ou yoga. L’acoustique ne permet pas les projections.', equipment: ['Sonorisation', 'Éclairage scénique'], icon: 'sparkles' },
  ...
  { id: 'salon-collectif', site: 'marseille', name: 'Le Salon collectif', capacity: 15, rate: 20, prices: { half: 80, day: 150 }, area: 28, color: 'lavender', description: 'Espace de vie des résidentes le soir et le week-end. Ni casiers ni paperboard.', equipment: [], icon: 'sofa' },
