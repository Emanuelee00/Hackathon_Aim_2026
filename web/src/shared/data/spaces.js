...
export const spaces = [
  ...
  { id: 'chapelle', site: 'marseille', name: 'La Chapelle', capacity: 100, rate: 20, area: 114, color: 'peach', description: 'Chapelle désacralisée : concerts, spectacles, cours de danse ou de yoga. Cours hebdomadaire ouvert : 30€/heure. Location privée par tarif forfaitaire : 2h = 40€, ½ journée = 100€, journée = 200€ (le tarif horaire indiqué est une base pour le devis). Problème connu : l’acoustique ne permet pas de projeter des films.', equipment: [], icon: 'sparkles' },
  { id: 'salon-collectif', site: 'marseille', name: 'Le Salon collectif', capacity: 20, rate: 20, area: 28, color: 'lavender', description: 'Réunions internes, location pour séminaires ou réunions extérieures, coin télé ouvert aux résidentes surtout le soir et le week-end. Tarif forfaitaire : ½ journée = 80€, journée = 150€ (le tarif horaire indiqué est une base pour le devis). Espace partagé : propreté à surveiller, pas encore équipé (ni casier fermant à clé, ni paperboard).', equipment: [], icon: 'sofa' },
  ...
  { id: 'jardin-partage', site: 'marseille', name: 'Le Jardin', capacity: null, rate: null, area: null, color: 'lavender', description: 'Jardin partagé, avec une buvette le jeudi soir et des ateliers jardin le week-end animés par une bénévole. Espace de passage et non clos (louer une autre salle donne aussi accès au jardin), avec un enjeu de respect de l’intimité et du calme des dames. Prix envisagés si loué (2h = 40€, ½ journée = 100€, journée = 200€) mais la question de le louer reste ouverte en interne.', equipment: [], icon: 'leaf' },
  { id: 'petites-cantines', site: 'marseille', name: 'Les Petites Cantines', capacity: null, rate: null, area: 32, color: 'sage', description: 'Réfectoire de 32 m² avec une terrasse de 30 m², cantine partagée et solidaire. Privatisable pour des événements, à organiser directement avec l’association partenaire Les Petites Cantines.', equipment: [], icon: 'coffee' },
  { id: 'salle-reunion', site: 'marseille', name: 'La Salle de réunion', capacity: null, rate: null, area: 16, color: 'peach', description: 'Usage et tarif pas encore définis.', equipment: [], icon: 'dashboard' },
