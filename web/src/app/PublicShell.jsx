...
// Shell of the open subdomains (bénévoles, partenaires, bilan): no account needed.
export default function PublicShell({ children }) {
  const { storageError, toast } = useStore();
  return <div className="resident-app">
    <header className="resident-topbar"><Brand /><div className="header-actions"><span className="demo-label"><span />Données de démonstration</span></div></header>
